...
[eq_123ref,eq_123tests,eq_123bifs,eq_123bifind]=...
    MonitorChange(fun_eq123,eq_123,'print_residual_info',0,'min_iterations',5);
...
[eq_12_34ref,eq_12_34tests,eq_12_34bifs,eq_12_34bifind]=...
    MonitorChange(fun_eq12_34,eq_12_34,'print_residual_info',0,'min_iterations',5);
...
figure(3);clf;ax3=gca;hold(ax3,'on');grid(ax3,'on');
...
figure(4);clf;ax4=gca;hold(ax4,'on');grid(ax4,'on');
