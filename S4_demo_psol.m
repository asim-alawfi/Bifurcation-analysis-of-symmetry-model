...
[eq_1234ref,eq_1234tests,eq_1234bifs,eq_1234bifind]=...
    MonitorChange(fun_1234,eq_1234,'print_residual_info',0,'min_iterations',5);
...
% 1=2=3 (time shift 0)
ev1234=permfix('stst','p1234_1_4',n_osc,'v','perm',[1,2,3,4],'rotation',[1,4]);
sv_1234=check_hopf(ev1234)'
% 1=2=3 (time shift 0)
ev123=permfix('stst','pv123',n_osc,'v','perm',[1,2,3],'rotation',[0,1]);
sv_123=check_hopf(ev123)'
%1=2 (time shift 0),3=4 (time shift 0), 1=3 (time shift 1/2)
ev12_34=[permfix('stst','pv12_0_1',n_osc,'v','perm',[1,2],'rotation',[0,1]),...
         permfix('stst','pv34_0_1',n_osc,'v','perm',[3,4],'rotation',[0,1]),...
         permfix('stst','pv13_1_2',n_osc,'v','perm',[1,3],'rotation',[1,2])];
...
hopfsyms={ev1234,ev123,ev12s_34,ev12_34};
...
psargs={'extracolumns','auto','extra_condition',true,... % important for imposing symmetry
    ...
    'max_step',[0,0.1],'print_residual_info',1}; % stepsize along branch
figure(1);
...
[ehopffun,ehopf,suc]=SetupHopf(funcs,eq_1234ref,eq_1234bifind,...
    ...
    'initcond',ev1234,'usercond',ev1234,'outputfuncs',true)
...
%% Yes, so try and initialize branch
[pffun,pfbr,suc]=SetupPOEV1(funcs,psolref.(sm),indbif,'contpar',[ip.tau_c,ip.tau_s],...
    'dir',ip.tau_c,'step',1e-2,poev1args{:},'plot_measure',[],...
    'print_residual_info',1,'max_step',[0,0.5],'use_tangent',true,'min_angle',0.5);
...
[eq_1234sref,eq_1234stests,eq_1234sbifs,eq_1234sbifind]=...
    MonitorChange(fun_1234s,eq_1234s,'print_residual_info',0,'min_iterations',5);
...
[trfuncs,trbr,suc]=SetupTorusBifurcation(funcs,spsolcref,indbif,torargs1{:},...
    ...
    'print_residual_info',1,'TorusInit.initmethod','svd');
figure(2);
